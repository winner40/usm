		...
		struct list_head *uf)
{
	...
	vma = vma_merge(mm, prev, addr, addr + len, vm_flags,
			NULL, file, pgoff, NULL, NULL_VM_UFFD_CTX, NULL); /* prev ? prev->vm_userfaultfd_ctx : NULL_VM_UFFD_CTX *TODO* VM_UFFD_MISSING merging case */
	if (vma) {
		goto out;
	}
